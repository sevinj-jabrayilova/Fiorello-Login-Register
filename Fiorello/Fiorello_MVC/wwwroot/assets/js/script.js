$(document).ready(function () {
    ...
    let deleteItemFromBasketBtns = document.querySelectorAll(".delete-basket-data");

    deleteItemFromBasketBtns.forEach(btn => {
        btn.addEventListener("click", async function () {
            let id = parseInt(this.getAttribute("data-id"));
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var res = await sendDataToDelete(id);
                    this.closest("tr").remove();
                    const totalPriceItem = document.querySelector(".total-price");
                    if (totalPriceItem) {
                        totalPriceItem.innerText = `Total Price: ${res.totalPrice}$`;
                    }
                    Swal.fire({
                        title: "Deleted!",
    ...
    async function sendDataToDelete(id) {
        const url = `/Basket/DeleteItem?id=${id}`;
